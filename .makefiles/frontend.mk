...
open-release:
	...
	@if [ -d /home/rehan/kaleening/app/android/app/build/outputs/apk/release ]; then \
		explorer.exe "$$(wslpath -w /home/rehan/kaleening/app/android/app/build/outputs/apk/release)"; \
	else \
